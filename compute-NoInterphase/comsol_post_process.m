...
str_EpsilonBulkImag = sprintf('real(ec.Jy/%.3g[V])*%.3g*1000[nm]/ec.freq/2/3.14/8.85e-12[F/m]',AppliedVoltage,dimensionY);
...
str_EpsilonBulkReal = sprintf('imag(ec.Jy/%.3g[V])*%.3g*1000[nm]/ec.freq/2/3.14/8.85e-12[F/m]',AppliedVoltage,dimensionY);
