...
str_EpsilonBulkImag = sprintf('real(ec.Jy/%.3g[V])*%.3g[nm]/ec.freq/2/3.14/8.85e-12[F/m]',AppliedVoltage,dimensionY);
...
str_EpsilonBulkReal = sprintf('imag(ec.Jy/%.3g[V])*%.3g[nm]/ec.freq/2/3.14/8.85e-12[F/m]',AppliedVoltage,dimensionY);
...
model.result.export('img1').set('tifffilename', [savefile,'Efield.tiff']);
